...
\input{authors.tex}
\author{Conghao Zhou, Tesla Jeltema, Anja von der Linden, Alexie Leauthaud}
...
In this note, we focus on two relatively massive galaxies in the Rubin ComCam commissioning data, the brightest central galaxy of Abell 360 and 2dFGRS TGS323Z113 \citedsp{SITCOMTN-149}. We measure the surface brightness profiles of the central galaxies in these clusters and compare them to precursor data.
